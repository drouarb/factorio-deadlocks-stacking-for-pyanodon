return {
    ...
    {item = "phenolicboard", icon = nil, iconName = "phenolic-board", stage = 2},
    ...
    {item = "py-fertilizer", icon = nil, iconName = "fertilizer", stage = 2, inFinalFixes = true},
    ...
    {item = "bones", icon = nil, iconName = "bone", stage = 2},
    {item = "transistor", icon = nil, stage = 2, icon_size = 64},
    ...
    {item = "processing-unit", icon = nil, iconName = "circuit-board-3", inFinalFixes = true, stage = 3, icon_size = 64},
    ...
    {item = "re-tin", icon = nil, iconName = "re-tin-alloy", stage = 3},
    ...
    {item = "nanochip", icon = nil, iconName = "nano-chip", stage = 3},
    ...
    {item = "paramagnetic-material", icon = nil, stage = 3, icon_size = 64}
}
